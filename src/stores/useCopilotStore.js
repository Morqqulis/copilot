...
const createUserSlice = (set) => ({
  ...
  updateUserIsSubscribed: (newSubscriptionState) =>
    set({ userIsSubscribed: newSubscriptionState }),
});
...
const createSettingsSlice = (set) => ({
  ...
  setTranslationLanguage: (languageCode) =>
    set({ translationLanguage: languageCode }),
});
...
const createStoriesSlice = (set) => ({
  segmentStories: {
    intro: [
      {
        content: "Her er siste nytt fra Radio Norge",
        selected: true,
        enhancedContent: "Her er siste nytt fra Radio Norge",
      },
    ],
    news: null,
    weather: null,
    ...
    outro: [
      {
        content:
          "Og det var alt for i dag! Takk for at du lyttet – hold deg skarp, hold deg sterk, og vi høres neste gang!",
        selected: true,
        enhancedContent:
          "Og det var alt for i dag! Takk for at du lyttet – hold deg skarp, hold deg sterk, og vi høres neste gang!",
      },
  ...
  updateSelectedStories: (segmentName, index, newStory) =>
    set((state) => ({
      segmentStories: {
        ...
        [segmentName]: state.segmentStories[segmentName].map((story, i) =>
          i == index ? newStory : story
        ),
      },
    })),
